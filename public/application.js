...
var onGetPlayers = function onGetPlayers(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.getPlayers(data).then(ui.getPlayersSuccess).catch(ui.getPlayersFailure);
};

var onGetSinglePlayer = function onGetSinglePlayer(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.getSinglePlayer(data).then(ui.getSinglePlayerSuccess).catch(ui.getSinglePlayerFailure);
};

var onDeletePlayer = function onDeletePlayer(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.deletePlayer(data).then(ui.deletePlayerSuccess).then(api.indexUserPlayers).then(ui.userIndexSuccess).catch(ui.deletePlayerFailure);
};

var onUserPlayersIndex = function onUserPlayersIndex(event) {
  event.preventDefault();
  api.indexUserPlayers().then(ui.userIndexSuccess).catch(ui.userIndexFailure);
};

var onAddUserPlayer = function onAddUserPlayer(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.addUserPlayer(data).then(ui.addUserPlayerSuccess).then(api.indexUserPlayers).then(ui.userIndexSuccess).catch(ui.addUserPlayerFailure);
};

var onUpdatePlayer = function onUpdatePlayer(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.updatePlayer(data).then(ui.updatePlayerSuccess).then(api.indexUserPlayers).then(ui.userIndexSuccess).catch(ui.updatePlayerFailure);
};
...
var hideAuthForms = function hideAuthForms() {
  $('.auth-content').hide();
};

hideAuthForms();

var hideClientForms = function hideClientForms() {
  $('.client-forms').hide();
};
...
module.exports = {
  ...
  onGetSinglePlayer: onGetSinglePlayer,
  onUpdatePlayer: onUpdatePlayer,
  addHandlers: addHandlers,
  onUserPlayersIndex: onUserPlayersIndex,
  onAddUserPlayer: onAddUserPlayer,
...
var getSinglePlayer = function getSinglePlayer(data) {
  return $.ajax({
...
var indexUserPlayers = function indexUserPlayers() {
  return $.ajax({
...
var addUserPlayer = function addUserPlayer(data) {
  return $.ajax({
    url: config.apiOrigin + '/fantasy_players',
    method: 'POST',
    headers: {
...
module.exports = {
  ...
  indexUserPlayers: indexUserPlayers,
  addUserPlayer: addUserPlayer,
...
var store = __webpack_require__(6);
var showPlayersHtml = __webpack_require__(17);
var showUserPlayersHtml = __webpack_require__(34);
var getSingleResource = __webpack_require__(35);
...
var onSignOutFailure = function onSignOutFailure(data) {
...
var getPlayersSuccess = function getPlayersSuccess(data) {
  ...
  $('.clear-input').html('');
  var showPlayers = showPlayersHtml({ players: data.players });
  $('.content').html('');
...
var getSinglePlayerSuccess = function getSinglePlayerSuccess(data) {
  if ($('.clear-input-single').val() !== '') {
    $('.alerts').text('Successfully Retrieved Single Resource');
    var singleResource = getSingleResource({ players: data });
...
var getSinglePlayerFailure = function getSinglePlayerFailure(data) {
  $('.clear-input-single').val('');
...
var userIndexSuccess = function userIndexSuccess(data) {
  $('.user-alerts').text('Successfully Retrieved Your Players');
  var showUserPlayers = showUserPlayersHtml({ fantasy_players: data.fantasy_players });
  $('.create-content').html('');
  $('.create-content').append(showUserPlayers);
};

var userIndexFailure = function userIndexFailure() {
  $('.alerts').text('Failed To Get Your Players');
};

var addUserPlayerSuccess = function addUserPlayerSuccess(data) {
...
var addUserPlayerFailure = function addUserPlayerFailure(data) {
...
var deletePlayerFailure = function deletePlayerFailure(data) {
  $('.update-alert').text('Failed To Remove Player');
};

var updatePlayerSuccess = function updatePlayerSuccess(data) {
  $('.clear-input').val('');
  $('.create-content').html('');
...
var updatePlayerFailure = function updatePlayerFailure(data) {
  $('.input').val('');
...
module.exports = {
  ...
  getSinglePlayerSuccess: getSinglePlayerSuccess,
  getSinglePlayerFailure: getSinglePlayerFailure,
  userIndexSuccess: userIndexSuccess,
  userIndexFailure: userIndexFailure,
  addUserPlayerSuccess: addUserPlayerSuccess,
  addUserPlayerFailure: addUserPlayerFailure,
  deletePlayerSuccess: deletePlayerSuccess,
  deletePlayerFailure: deletePlayerFailure,
  updatePlayerFailure: updatePlayerFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <ul class=\"player-form\" data-id=\""
    ...
    + "</div>\n    <div>Team: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.team : stack1), depth0))
    + "</div>\n    <div>Bye: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.bye : stack1), depth0))
    + "</div>\n      <div class=\"add-resource-player\">\n        <form class=\"add-form\">\n          <fieldset>\n          <input class=\"add-button\" type =\"submit\" name=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" value=\"Add Player\"></input>\n          <input class=\"id-value\" name=\"fantasy_player[player_id]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"hidden\"></input>\n          </fieldset>\n        </form>\n      </div>\n      <div><button class=\"remove\">hide player</button></div>\n    </ul>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <ul class=\"client-forms\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n    <div> Fantasy_Id: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " </div>\n    <div> Player_Id: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.player_id : stack1), depth0))
    + " </div>\n    <div> Name: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.player : stack1)) != null ? stack1.name : stack1), depth0))
    + " </div>\n    <div> Team: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.player : stack1)) != null ? stack1.team : stack1), depth0))
    + " </div>\n    <div> Bye: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.player : stack1)) != null ? stack1.bye : stack1), depth0))
    + " </div>\n    <div> Target: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.target : stack1), depth0))
    + " </div>\n    <div class=\"update-player\">\n      <form class=\"update-form client-forms\">\n        <fieldset>\n        <input class=\"target-button\" type =\"submit\" name=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" value=\"Target Player\"></input>\n        <input class=\"id-value\" name='fantasy_player[id]' value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type='hidden'>\n        <input class=\"id-value\" name=\"fantasy_player[player_id]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.player_id : stack1), depth0))
    + "\" type=\"hidden\"></input>\n        <input type=\"text\" name='fantasy_player[target]' class=\"clear-input\" placeholder='target?'>\n        </fieldset>\n      </form>\n    </div>\n    <div class=\"delete-resource-player\">\n      <form class=\"delete-form\">\n        <input class=\"delete-button\" type =\"submit\" name=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" value=\"Delete\"></input>\n        <input class=\"id-value\" name=\"id\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"hidden\"></input>\n      </form>\n    </div>\n</ul>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.fantasy_players : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n\n";
},"useData":true,"useBlockParams":true});
